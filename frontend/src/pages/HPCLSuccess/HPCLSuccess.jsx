...
import styles from './HPCLSuccess.module.css';

const DEFAULT_WHATSAPP_LINK = 'https://chat.whatsapp.com/HPCLCricket2026DummyLink';
...
export default function HPCLSuccess() {
  ...
  const copyToClipboard = () => navigator.clipboard.writeText(regId);
      ...
      <div className={styles.card}>
        ...
        <div className={styles.gifWrap}>
          <img
            ...
            alt="You're in!"
            className={styles.cricketGif}
          />
        </div>

        <h1 className={styles.title}>🏏 You're Registered!</h1>
        <p className={styles.subtitle}>
          {userName ? `Great going, ${userName}! ` : ''}Your registration is confirmed.
        </p>
        ...
        {(userPhone || userGroup) && (
          <div className={styles.summary}>
            <div className={styles.summaryRow}>
              ...
              <span className={styles.summaryVal}>HPCL - Hari Prabodham Cricket League 2026</span>
            </div>
            {userPhone && (
              <div className={styles.summaryRow}>
                <span className={styles.summaryKey}>Phone</span>
                <span className={styles.summaryVal}>+91 {userPhone}</span>
              </div>
            )}
            {userGroup && (
              <div className={styles.summaryRow}>
                <span className={styles.summaryKey}>Group</span>
                <span className={styles.summaryVal}>{userGroup}</span>
              </div>
            )}
          </div>
        )}
        ...
        <div className={styles.waCard}>
          <div className={styles.waCardHeader}>
            ...
            <div>
              ...
              <p className={styles.waDesc}>Get match schedules, updates &amp; announcements directly on WhatsApp.</p>
            </div>
          </div>
          <a
            href={WHATSAPP_LINK}
        ...
        <div className={styles.actions}>
          <Link to="/hpcl-2026" className={styles.backBtn}>
