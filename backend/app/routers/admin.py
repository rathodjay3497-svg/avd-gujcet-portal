...
def _flatten_reg(r: dict) -> dict:
    ...
    return {
        ...
        "graduation_degree": fd.get("graduation_degree", ""),
...
def export_registrations(event_id: str, _admin=Depends(require_admin)):
    ...
    for r in regs:
        ...
        row = [
            ...
            flat["phone"],
            flat["gender"],
            f"Graduation - {flat['graduation_degree']}" if flat["standard"] == "Graduation" and flat.get("graduation_degree") else flat["standard"],
